...
from core.langgraph_.agents import (explainer, fig_reviewer, async_fig_fixer,
                                    async_explanation_processor,async_coder,
                                    explaination_decision_controller,explanation_reviewer,
                                    contextual_prompt_generator, fig_decision_controller)
...
workflow_hitl.add_node("explaination_decision_controller", explaination_decision_controller)
...
workflow_hitl.add_conditional_edges(
    ...
    {
        "fix":"explainer",
        "continue":"async_explanation_processor"
    }
)
...
workflow_hitl.add_edge("async_fig_fixer",END)